...
export class EditPage implements OnInit {
  ...
  public carregarModelos(){
    ...
    this.modeloId = null;   
    this.modelosDaMarca = this.veiculoService.getModelosByMarcaId(this.marcaId);
  ...
  public atualizarVeiculo(){
    ...
    if(this.veiculo.placa.trim().length != 0 && this.veiculo.placa != undefined && this.veiculo.placa.length == 8 && this.veiculo.cor != undefined && this.marcaId != undefined && this.modeloId != undefined){
